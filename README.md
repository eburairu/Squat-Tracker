...
- **クラスシステム**: 「戦士」「魔法使い」「盗賊」などのクラス（職業）を選択し、攻撃力アップやクリティカル率上昇などのボーナス効果を得られます。さらに、使い続けることで**熟練度**が上がり、クラスレベルが上昇するとボーナス効果が強化されます。
...
11. **シェア**: トレーニング完了画面の「シェア画像を作成」ボタンから、本日の戦績カードを保存してシェアできます。
